...
/**
 * —умма модулей элементов после элемента с максимальным модулем
...
/**
 * ѕоиск индекса максимального элемента, меньшего A (вариант 8)
...
/**
 * —оздание динамического массива D без минимумов из массивов A, B, C
 * @param a массив A
 * @param na размер A
 * @param b массив B
 * @param nb размер B
